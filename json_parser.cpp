...
namespace json_utils {
	...
	std::map<json_tables::json_tokens, std::string> json_tables::spelling_ {
		...
		{
			json_tables::json_tokens::TRUE_TOKEN,
			"true"
		},
		{
			json_tables::json_tokens::FALSE_TOKEN,
			"false"
		},
		{
			json_tables::json_tokens::NULL_TOKEN,
			"null"
		},
		{
			json_tables::json_tokens::STRING_TOKEN,
			"<string>"
		},
		{
			json_tables::json_tokens::NUMBER_TOKEN,
			"<jnumber"
		},
		{
			json_tables::json_tokens::EOFTOKEN,
			"<eof>"
		},
		{
	...
	bool parse_string(const std::string &source, json_value &value) {
		json_string_lexer slexer {
			source
		};
		json_string_parser sparser {
			slexer
		};
	...
	bool parse_file(const std::string &filename, json_value &value) {
		json_file_lexer slexer {
			filename
		};
		json_file_parser sparser {
			slexer
		};
